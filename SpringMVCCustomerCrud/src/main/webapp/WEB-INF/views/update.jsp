...
<body onload="document.getElementById('customerForm').reset();" >

<div class="form-container">
    <h2 class="form-title">Customer Details Update Form</h2>
    <form id="customerForm" action="updateData?id=${customer.id}" method="post">
    
    	<input type="hidden" name="id" value="${customer.id}">
    	
    	<!-- take this two as hidden to get original value means they enter same mobile and email it does not show error of already exists -->
    	<input type="hidden" name="mobileno" id="mobileno" value="${customer.mobileNo}"> 
    	<input type="hidden" name="emailid" id="emailid" value="${customer.email}">
        ...
        <input type="hidden" name="formName" id="formName" value="noCheck">
        <button type="submit" class="formbold-btn disabled">Update Details</button>
